...
let RegisterUserComponent = class RegisterUserComponent {
    ...
    onSubmit(signInForm) {
        const signInData = new _models_signInData__WEBPACK_IMPORTED_MODULE_2__["SignInData"](signInForm.value.email, signInForm.value.password);
